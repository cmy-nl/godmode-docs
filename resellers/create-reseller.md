...
- A license ready to assign (or create one during this flow). See [Licenses →](/docs/licenses/issue-license)
...
If the reseller was provisioned via the WHMCS module, steps 1–6 happen automatically. You only need to manually create resellers for direct accounts. See [WHMCS integration →](/docs/instances/whmcs-integration)
:::
