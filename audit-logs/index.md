...
Audit logs are retained for **2 years** by default. Retention period can be adjusted in [Settings → Security →](/docs/settings/security). Logs cannot be deleted by any user, including Super Admins.

## Related pages

- [Reading audit logs →](/docs/audit-logs/reading-logs)
- [Filter and export →](/docs/audit-logs/filter-export)
- [Log retention policy →](/docs/audit-logs/log-retention)
