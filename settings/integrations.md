...
4. Update the key in your WHMCS module configuration. See [WHMCS integration →](/docs/instances/whmcs-integration).
...
See [Payment methods → Stripe →](/docs/billing/payment-methods).

## Mollie

See [Payment methods → Mollie →](/docs/billing/payment-methods).
