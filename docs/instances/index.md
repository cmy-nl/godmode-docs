...
- **Branding configuration** — applied from the [Brandings →](/brandings) section
...
- [Create an instance →](/instances/create-instance)
- [Instance configuration →](/instances/instance-configuration)
- [WHMCS integration →](/instances/whmcs-integration)
- [Docker deployment →](/instances/docker-deployment)
- [Licenses →](/licenses)
