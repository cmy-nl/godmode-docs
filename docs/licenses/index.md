...
When a license expires or is suspended, the instance enters a **48-hour grace period** before access is blocked. This prevents disruption from payment processing delays. You can configure the grace period duration in [Settings →](/settings/general).

## Related pages

- [Issue a license →](/licenses/issue-license)
- [License types →](/licenses/license-types)
- [Revoke or suspend a license →](/licenses/revoke-suspend)
- [WHMCS integration →](/instances/whmcs-integration)
