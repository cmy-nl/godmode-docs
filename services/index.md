...
Each service has a credit cost per action, configured at the platform level in [Settings →](/docs/settings/general). Resellers and end clients see the credit cost before confirming each action.

## Related pages

- [Available services →](/docs/services/available-services)
- [Enable or disable a service →](/docs/services/enable-disable)
- [Service configuration →](/docs/services/service-configuration)
- [Packages →](/docs/packages) — packages control which services are included per reseller tier
