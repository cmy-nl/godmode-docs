...
When a WHMCS order is activated, the provisioning module calls the GodMode API to issue a license automatically and bind it to the newly created instance. No manual steps are required. See [WHMCS integration →](/docs/instances/whmcs-integration).
