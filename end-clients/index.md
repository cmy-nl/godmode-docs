...
End clients consume credits from their reseller's pool each time they use an AI-powered feature. The reseller sets any limits on their end clients' credit usage. The Super Admin sees total consumption platform-wide on the [Dashboard →](/docs/dashboard).
...
- [Create an end client →](/docs/end-clients/create-end-client)
- [Manage end clients →](/docs/end-clients/manage-end-clients)
- [Client brand access →](/docs/end-clients/client-brand-access)
