...
## Filtering
Use the filter controls above the feed to scope by event type, actor role, or date range. For a fully exportable, tamper-evident log, see [Audit logs →](/docs/audit-logs).
